// JavaScript for Breast Cancer Prediction page

document.addEventListener('DOMContentLoaded', function() {
    const breastCancerForm = document.getElementById('breastCancerForm');
    
    if (breastCancerForm) {
        breastCancerForm.addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            .then(data => {
                ...
                if (data.error) {
                    ...
                    if (data.result.includes('Benign')) {
